...
Il rapporto pitagorico è definito come il rapporto tra le frequenze di due suoni che formano un intervallo di quinta perfetta ([Tetraktys](https://it.wikipedia.org/wiki/Tetraktys)). L'intervallo di quinta perfetta corrisponde a una proporzione di 3:2 nelle frequenze. <br>
Questo significa che se la nota **LA** ha una frequenza di **440 Hz**, la nota successiva **MI**, che forma una quinta perfetta con LA, avrà una frequenza di **660 Hz**, ovvero **440 Hz x 3:2**.
...
All'inizio del periodo [Barocco](https://it.wikipedia.org/wiki/Barocco), siamo circa nel 1600, si è cercato di trovare un compromesso tra la poco pratica potenza musicale del sistema di Gioseffo Zarlino e l'inesattezza che abbiamo riscontrato in alcuni casi nell'accordatura pitagorica e naturale.<br><br>
...
Proprio come il sistema mesotonico, il temperamento Werckmeister fa delle compensazioni sugli altri intervalli dell'ottava, pur cercando di mantenere quanto più possibile inalterati i rapporti matematici puri del sistema naturale e di Pitagora. <br>
...
L'accordatura nella musica indiana, sia classica che popolare, è fondamentale per l'esecuzione delle melodie [ragas](https://it.wikipedia.org/wiki/Raga) che caratterizzano questa tradizione musicale. La musica indiana utilizza un sistema di intonazione naturale basato su **rapporti armonici puri**, noti come [Shruti](https://it.wikipedia.org/wiki/Srutis#:~:text=Gli%20srutis%20sono%20i%203,sette%20tra%20toni%20e%20semitoni.).<br>
Il sistema indiano riconosce 22 microtoni (shruti) all'interno dell'ottava, anche se la pratica musicale si basa su **una selezione di note specifiche per ogni raga**. Le shruti sono i gradini più piccoli di intonazione che formano la base delle note: <br>
...
| Altre tradizioni                | Caratteristiche uniche, rappresentative delle culture locali      | Non sempre compatibili con la musica occidentale                       |  
